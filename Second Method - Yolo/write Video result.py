        ...
        for j in ball_info.keys():
            ...
            if ball_info[j]["previous_state"] != ball_info[j]["current_state"] and ball_info[j]["color"]!=" ":
                ...
                if ball_info[j]["current_state"]==1: #Enter
                    ...
                    cv2.putText(frame,str(ball_info[j]["color"])+"Ball Entered at" + str(sec),(x,y),FONT_FACE,1,(0,255,0),2, cv2.LINE_AA)
                    ...
                    data_ball.append([sec,j,ball_info[j]["color"],"Exit"])
                    cv2.putText(frame,str(ball_info[j]["color"])+"Ball Exit at" + str(sec),(x,y),FONT_FACE,1,(0,255,0),2, cv2.LINE_AA)
...
video_output_file_name = "yolo_video.mp4"
width = 1080
height= 1080
fps_write = 20 
